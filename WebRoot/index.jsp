...
#tfm_header_menu .menu_list { height:25px;margin-left:211px;}
...
<table id="tfm_table" cellpadding="0" cellspacing="0"  width="100%"  height="100%" >
    <tr>
        <td class="top" valign="top" style="background: #00B2EE;"><iframe src="<%=path%>/top.jsp" width="100%" height="100px" frameborder="0"  id="iframe_top" name="iframe_top" scrolling="no"></iframe>
        </td>
    </tr>
    <tr>
        <td  valign="top"  >
          <table  id="content" cellpadding="0" cellspacing="0" width="100%" height="100%" style="overflow:hidden;table-layout:fixed;">
            <tr>
              <td valign="top" width="176" nowrap="nowrap" id="tfm_left" style="overflow:hidden;">
                  <iframe src="left2.jsp" width="176" height="100%"  frameborder="0"  id="iframe_left" name="iframe_left" ></iframe>
                </td>
            ...
            <img src="images/guanli_25.png" name="img1" width="8" height="48" id="img1"/>
                ...
                <td class="right-content" valign="top" align="left">
                    <iframe src="<%=path%>/Police!list.action" width="100%" height="100%" frameborder="0"  id="iframe_content" name="iframe_content"></iframe>
                </td>
            </tr>
          </table>
        </td>
    ...
    <tr>
        <td  class="bottom"  style="height:20px;background-color:#2296d3;" >
          <center style="color:white"><a style="color:white" href="http://www.miitbeian.gov.cn/" target="_bank">浙江浙天网络科技有限公司版权所有</a>&nbsp;|&nbsp;宁海桃园派出所警民通后台管理<span id="onlineCountId"></span></center>
        </td>
    </tr>
</table>
<script type="text/javascript">
